        ...
        if len(sys.argv) > 2:
            ...
            if action == "testdata1":
                ...
                merkurius.set_location(-58000000000.0,0,0) #-58000000000.0
                ...
                controller.set_object_angle_speed(merkurius, 47870.0,-90,0) #47870.0
            ...
            if action == "testdata3":
                ...
                controller.universe.maths.time = 5
